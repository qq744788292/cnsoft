...
public class PKHelper implements ISFrameworkConstants {
	private static String MACHINE_FILE = "machine.properties";
	private static String MACHINE_CODE = "machinecode";
	...
	static {
		try {
			...
			InputStream in = new BufferedInputStream(new FileInputStream(MACHINE_FILE));
			props.load(in);
