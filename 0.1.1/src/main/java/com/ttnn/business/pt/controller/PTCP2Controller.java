...
@Controller
@RequestMapping("PTCP2")
/** 系统公告*/
public class PTCP2Controller extends MyControllerSupportImpl {

//  产品功能信息
    @Resource
    protected PTCP02Service ptcp02Service_;
	...
	public MyServiceSupportImpl getService() {
		return ptcp02Service_;
	}
	
	@Override	
    public Logger getLogger(){
        return LoggerFactory.getLogger(PTCP2Controller.class);
    }
	/**
   	 * 页面视图
   	 */
	...
	public ModelAndView getModelAndView() {
		return new ModelAndView("PT/PTCP02R");
	} 
	 ...
	 public ModelAndView home(CSPVOSupport paramBean){
		 	getLogger().debug("paramBean" + paramBean);
	   		...
	   		pageMAV.setViewName("PT/PTCP02R");
		...
		public ModelAndView toInsert(CSPVOSupport paramBean) {
			ModelAndView pageMAV = getModelAndView();
			getLogger().debug("paramBean===>>>" + paramBean);
			pageMAV.setViewName("PT/PTCP02C");		
			getLogger().debug("pageMAV===>>>" + pageMAV);
			return pageMAV;
		}
		/**
		...
		public ModelAndView doInsert(CSPVOSupport paramBean) {
			...
			String url = "redirect:/PTCP2/F.go";
		...
		public ModelAndView toSearch(CSPVOSupport paramBean) {
			ModelAndView pageMAV = getModelAndView();
			getLogger().debug("paramBean===>>>" + paramBean);
			pageMAV.setViewName("PT/PTCP02S");
			getLogger().debug("pageMAV===>>>" + pageMAV);
			return pageMAV;
		}
		/**
		...
		public ModelAndView doRead1(CSPVOSupport paramBean) {
			...
			pageMAV.addObject("parambean1", ptydService_.doFindList2(paramBean));
