...
@RequestMapping("PTCP")
/** 产品信息*/
public class PTCPController extends MyControllerSupportImpl {
//	产品信息
    @Resource
    protected PTCP01Service ptcp01Service_;
//  产品销售套餐分类
    @Resource
	...
	public ModelAndView getModelAndView() {
		return new ModelAndView("PT/PTCP01R");
	} 
	 ...
	 public ModelAndView home(CSPVOSupport paramBean){
		 	getLogger().debug("paramBean" + paramBean);
	   		...
	   		pageMAV.setViewName("PT/PTCP01R");
		...
		public ModelAndView doInsert(CSPVOSupport paramBean) {
			...
			ptcp03Service_.doInsert(paramBean);
			if (result == 1) {
		...
		public ModelAndView toSearch(CSPVOSupport paramBean) {
			ModelAndView pageMAV = getModelAndView();
			getLogger().debug("paramBean===>>>" + paramBean);
			pageMAV.setViewName("PT/PTCP01S");
			getLogger().debug("pageMAV===>>>" + pageMAV);
			return pageMAV;
		}
		/**
