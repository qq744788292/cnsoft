...
@Controller
@RequestMapping("PTFZ3")
/** 系统公告*/
public class PTFZ3Controller extends MyControllerSupportImpl {
    @Resource
	...
	public ModelAndView getModelAndView() {
		return new ModelAndView("PT/PTFZM1");
	} 
	 ...
	 public ModelAndView home(CSPVOSupport paramBean){
		...
		public ModelAndView doInsert(CSPVOSupport paramBean) {
			...
			String url = "redirect:/PTFZ3/F.go";
