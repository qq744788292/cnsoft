...
import com.ttnn.business.wm.dao.WMZKCHECKDao;
import com.ttnn.framework.page.bean.PageVO;
import com.ttnn.framework.support.impl.MyServiceSupportImpl;

/** 总控监管数据 */
@Service
public class WMZKCHECKService extends MyServiceSupportImpl {

	@Override
	public WMZKCHECKDao getDao() {
		return mySqlSession.getMapper(WMZKCHECKDao.class);
	}
