...
(
    ...
    f03 VARCHAR(20) DEFAULT '0',
    f04 VARCHAR(20) DEFAULT '0',
    f05 VARCHAR(20) DEFAULT '0',
    f06 VARCHAR(20) DEFAULT '0',
    f07 VARCHAR(20) DEFAULT '0',
    f08 VARCHAR(20) DEFAULT '0',
    f09 VARCHAR(20) DEFAULT '1:00:00',
    f10 VARCHAR(20) DEFAULT '0',
    f11 VARCHAR(20) DEFAULT '0',
    f12 VARCHAR(20) DEFAULT '0',
    f13 VARCHAR(20) DEFAULT '0',
    f14 VARCHAR(20) DEFAULT '0',
    f15 VARCHAR(20) DEFAULT '0',
    f16 VARCHAR(20) DEFAULT '0',
    f17 VARCHAR(20) DEFAULT '0',
    f18 VARCHAR(20) DEFAULT '2013/10/10',
    f19 VARCHAR(20) DEFAULT '0',
    f20 VARCHAR(20) DEFAULT '0',
    bbb VARCHAR(80),
    fb1 VARCHAR(20),
    fb2 VARCHAR(20),
    fb3 VARCHAR(20),
