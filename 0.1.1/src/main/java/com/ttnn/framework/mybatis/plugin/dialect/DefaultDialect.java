package com.ttnn.framework.mybatis.plugin.dialect;
 ...
 * @version 1.0
 */
public class DefaultDialect implements ISSystemConstants {
	private static final Logger logger = LoggerFactory.getLogger(DefaultDialect.class);
