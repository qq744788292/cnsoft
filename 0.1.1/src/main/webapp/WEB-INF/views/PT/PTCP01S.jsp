...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	function search(){
			document.form1.action = "/PTCP/A.go";
			form1.submit();
		}
	function back(){
			document.form1.action="/PTCP/F.go";
			form1.submit();
			}
	function clearForm(){
...
<body>
		  ...
		  <tr>
		    ...
		    <td align="right">
					  <button type="submit" class="btn btn-default btn-sm">
					  	<a href="http://localhost:8888/PTCP/F.go">返回</a>
					  </button>
	...
	<tr>
		<td>
			<table align="center" width="100%" style="margin:0; padding:0;" border="0">
				<tr height="40">
					<td width="20%" align="right">下拉选框：</td>
					<td width="5"></td>
					<td><select class="form-control" id="f03" name="f03" >
<!-- 						<option>支付通道名称</option> -->
						<c:forEach var="parambean1" items="${list}">
	        				<option value="${parambean1.f03}">${parambean1.f03}</option>
	        			</c:forEach>
					</select></td>
					<td width="5"></td>
					<td width="30%">备注</td>
...
<!-- 							<label class="control-label">下拉选框</label> -->
<!-- 						</td> -->
<!-- 						<td style="padding:0 10px;"> -->
<!-- 							<select class="form-control" id="f03" name="f03" > -->
<!-- 								<option>支付通道名称</option> -->
<!-- 								<c:forEach var="parambean1" items="${list}"> -->
<!-- 	        						<option value="${parambean1.f03}">${parambean1.f03}</option> -->
<!-- 	        					</c:forEach> -->
...
<!-- 					<tr height="30"><td colspan="3"></td></tr> -->
<!-- 					<tr height="50"> -->
<!-- 						<td align="right"><label>运营负责人</label></td>  -->
<!-- 						<td style="padding:0 10px;"><input type="text" id="k03" name="k03" value="${parambean1.k03}" ></td> -->
<!--                		</tr> -->
<!--                   	<tr height="10"><td colspan="2"></td></tr> -->
<!--           		</table> -->
<!-- 			</td> -->
