...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	function search(){
			document.form1.action = "/PTFZ1/R.go";
			form1.submit();
		}
	function back(){
			document.form1.action="/PTFZ1/F.go";
			form1.submit();
			}
	function clearForm(){	
...
// 	function add(){
// 			document.form1.action = "/PTCP/C.go";
// 			form1.submit();
// 		}
</script>
<body>
    ...
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
		<td><h4 style="margin-left:10px;">客户系统管理查询</h4></td>
	</tr>
	<tr>
		...
		<td>
			<table align="center" width="100%" style="margin:0; padding:0;" border="0">
				<tr height="40">
					...
					<td width="5"></td>
					<td><input type="text" class="form-control input-sm" id="puk" name="puk" maxlength="20" value="${parambean1.puk}"></td>
					<td width="5"></td>
					<td width="30%">备注</td>
				</tr>
				<tr height="40">
				...
				<tr height="40">
					...
					<td width="5"></td>
					<td><input type="text" class="form-control input-sm" id="f08" name="f08" value="${parambean1.f08}" maxlength="20"></td>
					<td width="5"></td>
					<td width="30%">备注</td>
				</tr>
				<tr height="40">
					<td width="20%" align="right">授权终了日期：</td>
					<td width="5"></td>
					<td><input type="text" class="form-control input-sm" id="f12" name="f12" value="${parambean1.f12}" maxlength="20"></td>
					<td width="5"></td>
					<td width="30%">备注</td>
				</tr>
				<tr height="40">
