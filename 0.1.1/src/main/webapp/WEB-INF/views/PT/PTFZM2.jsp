...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	<script type="text/javascript">
		...
		function save(){
			var  rs=document.formsb01.puk.value;
			 	if(rs!=""){
					document.formsb01.action="/PTFZ2/U.go";
					formsb01.submit();
				}else{
					document.formsb01.action="/PTFZ2/I.go";
 					formsb01.submit(); 				
				}
 		}
 		function back(){
			document.formsb01.action="/PTFZ2/F.go";
			formsb01.submit();
			}
		function clearForm(){	
  ...
  <table align="center" width="100%" style="margin:0; padding:0;" border="0">
    ...
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
      <td><h4 style="margin-left:10px;">管理员创建编辑</h4></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table align="center" width="100%" style="margin:0; padding:0;" border="0">
        ...
        <tr height="40">
          <td width="20%" align="right">人员编号：</td>
          <td width="5"></td>
        ...
        <tr height="40">
          ...
          <td width="5"></td>
          <td><input type="text" class="form-control input-sm" id="f03" name="f03" maxlength="20" value="${parambean1.f03}"></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
          ...
          <td width="5"></td>
          <td><input type="password" class="form-control input-sm" id="f04" name="f04" maxlength="64" value="${parambean1.f04}"></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
          <td width="20%" align="right">用户来源：</td>
          <td width="5"></td>
          <td><input type="text" class="form-control input-sm" id="f05" name="f05" maxlength="20" value="${parambean1.f05}"></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
          ...
          <td width="5"></td>
          <td><input type="text" class="form-control input-sm" id="f06" name="f06" maxlength="20" value="${parambean1.f06}"></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
          ...
          <td width="5"></td>
          <td><input type="text" readonly="readonly" class="form-control input-sm" id="eb5" name="eb5" maxlength="20" value="${parambean1.eb5}"></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
