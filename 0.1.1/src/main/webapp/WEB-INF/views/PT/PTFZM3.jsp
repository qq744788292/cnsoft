...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	function search(){
			document.form1.action = "/PTFZ2/R.go";
			form1.submit();
		}
	function back(){
			document.form1.action="/PTFZ2/F.go";
			form1.submit();
			}
	function clearForm(){	
...
<body>
    ...
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
		<td><h4 style="margin-left:10px;">管理员查询</h4></td>
	</tr>
	<tr>
		...
		<td>
			<table align="center" width="100%" style="margin:0; padding:0;" border="0">
				...
				<tr height="40">
					...
					<td width="5"></td>
					<td><input type="text" class="form-control input-sm" id="f03" name="f03" maxlength="20" value="${parambean1.f03}" maxlength="20"></td>
					<td width="5"></td>
					<td width="30%">备注</td>
				</tr>
				<tr height="40">
					...
					<td width="5"></td>
					<td><input type="text" class="form-control input-sm" id="f05" name="f05" maxlength="20" value="${parambean1.f05}" maxlength="20"></td>
					<td width="5"></td>
					<td width="30%">备注</td>
				</tr>
				<tr height="40">
					...
					<td width="5"></td>
					<td><input type="text" class="form-control input-sm" id="f06" name="f06" maxlength="20" value="${parambean1.f06}" maxlength="20"></td>
					<td width="5"></td>
					<td width="30%">备注</td>
				</tr>
				<tr height="40">
