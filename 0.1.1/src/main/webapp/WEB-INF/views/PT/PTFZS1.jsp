...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	function xiugai(puk,uu1) {
		if(uu1 == ""){
			document.form2.action="/PTFZ3/R.go?puk="+puk;
			form2.submit();	
		}else{	
			document.form2.action="/PTFZ3/R.go?puk="+puk+"&uu1="+uu1;
			form2.submit();	
		}	
	}
	function del(puk,uu1){
		if(uu1 == ""){
			document.form2.action="/PTFZ3/D.go?puk="+puk;	
			form2.submit();	
		}else{
			document.form2.action="/PTFZ3/D.go?puk="+puk+"&uu1="+uu1;
			form2.submit();	
		}
	}
	function search(){
			document.form1.action = "/PTFZ3/S.go";
			form1.submit();
		}
	function add(){
			document.form1.action = "/PTFZ3/C.go";
			form1.submit();
		}
</script>
<body>
    ...
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
		<td><h4 style="margin-left:10px;">授权期限一览与删除</h4></td>
	</tr>
		...
		<td>
			<table align="center" width="100%" border="0">
				<tr>
					<td width="2%"></td>
					<td align="left">
        				<pagtag:pagtag   pageVo="${pageVO}"  url="PTFZ3/F.go"/>
   					</td>
