...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	<script type="text/javascript">
		...
		function save(){
			var  rs=document.formsb01.puk.value;
			 	if(rs!=""){
					document.formsb01.action="/PTYDG/U.go";
					formsb01.submit();
				}else{
					document.formsb01.action="/PTYDG/I.go";
 					formsb01.submit(); 				
				}
 		}
		function back(){
			document.formsb01.action="/PTYDG/F.go";
			formsb01.submit();
			}
		function clearForm(){	
  ...
  <table width="100%" border="0">
    ...
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
      <td><h4 style="margin-left:10px;">系统公告一览与删除</h4></td>
    </tr>
    <tr>
    ...
    <tr style="border-top:1px solid #DBDBDB;">
      <td><table align="center" width="100%" style="margin:0; padding:0;" border="0">
        ...
        <tr height="40">
          ...
          <td width="5"></td>
          <td><input type="text" class="form-control input-sm" id="f02" name="f02" maxlength="20" value="${parambean1.f02}"></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
        ...
        <tr height="40">
          ...
          <td width="5"></td>
          	<td><input type="radio" name="fb1" id="fb1" value="${parambean1.fb1}"  onclick="selType(this.value)" />云平台
				<input type="radio" name="fb1" id="fb1" value="${parambean1.fb1}"  onclick="selType(this.value)"/>全产品
				<input type="radio" name="fb1" id="fb1" value="${parambean1.fb1}" onclick="selType(this.value)"/>全系统
			</td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
          ...
          <td width="5"></td>
          <td><textarea  rows="8" cols="40" id="f04" name="f04"  value="">${parambean1.f04}</textarea></td>
          <td width="5"></td>
          <td width="30%">备注</td>
        </tr>
        <tr height="40">
