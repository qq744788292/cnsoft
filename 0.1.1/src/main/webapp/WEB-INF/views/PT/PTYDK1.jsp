...
<!-- 	<link href="/resources/css/pt/global.css" rel="stylesheet" media="screen"> -->
	...
	function xiugai(puk,uu1) {
		if(uu1 == ""){
			document.form2.action="/PTYD/R.go?puk="+puk;
			form2.submit();	
		}else{	
			document.form2.action="/PTYD/R.go?puk="+puk+"&uu1="+uu1;
			form2.submit();	
		}	
	}
	function del(puk,uu1){
		if(uu1 == ""){
			document.form2.action="/PTYD/D.go?puk="+puk;	
			form2.submit();	
		}else{
			document.form2.action="/PTYD/D.go?puk="+puk+"&uu1="+uu1;
			form2.submit();	
		}
	}
	function search(){
			document.form1.action = "/PTYD/S.go";
			form1.submit();
		}
	function add(){
			document.form1.action = "/PTYD/C.go";
			form1.submit();
		}
</script>
<body>
    ...
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
		<td><h4 style="margin-left:10px;">客户系统管理系统授权</h4></td>
	</tr>
	...
	<!-- 分页 -->
    <tr><td align="left">
        <pagtag:pagtag   pageVo="${pageVO}"  url="PTYD/F.go"/>
   	</td></tr> 
