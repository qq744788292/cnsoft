...
<body>
<table align="center" width="95%" height="480"  border="0">
	<tr>
		<td width="100">
			<div class="sidebar">
									...
									<ul class="nav">
										<li class="on dropdown-submenu">
											...
											<ul class="dropdown-menu">
												<li><a class="nav-main-a" href="/CSSB01/H.go" target="BizFrame">充值</a></li>
...
<!-- 
  <frameset cols="280,*" border="10" framespacing="10">
		<frame src="/INDEX/LEFT.go" name="leftFrame" scrolling="no" noresize title="leftFrame">
		<frame src="/INDEX/MAIN.go" name="mainFrame" id="mainFrame" title="mainFrame" />
	</frameset><body>
</body></noframes>
</html>
 -->