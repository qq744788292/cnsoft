...
<script>
  ...
  <body>
   <sf:form class="form-horizontal" role="form" id="myForm" modelAttribute="check" method="post">
  <table width="100%" border="0">
 
  <sf:hidden path="puk"/>
  <sf:hidden path="uu1"/>	
    <tr height="40" style="border:1px solid #DBDBDB; background:#f8f8f8;">
      <td><h4 style="margin-left:10px;">银行卡审核未通过</h4></td>
    </tr>
    <tr>
      <td height="60"><table width="100%" border="0">
		  <tr>
          	<td width="2%"></td>
		    <td style="color:red; font-size:12px;">银行卡审核未通过</td>
		    <td align="right">
    ...
    <tr style="border-top:1px solid #DBDBDB;">
      ...
      <tr height="40">
        ...
        <tr height="40">
          ...
          <td width="5"></td>          
          <td><sf:input  path="f10" class="validate[required] text-input"/></td>
          <td width="5"></td>
          <td width="30%"></td>
        </tr>
