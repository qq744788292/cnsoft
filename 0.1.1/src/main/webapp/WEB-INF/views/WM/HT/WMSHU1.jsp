...
<script src="/resources/js/wm/qt/bootstrap.js"></script>
 ...
 <body>
  ...
  <sf:form method="get" modelAttribute="param" action="S.go">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         <td align="left" valign="top"><div class="tab-main dark-gray">
                   <h3 class="tab-main-title"><span style="font-size:14px; font-weight:bold;">审核会员</span></h3>
                 </div></td>
       </tr>
       <tr>
         <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <tr>
             <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
               <tr>
                 <td align="left" style="padding:20px;"><pagtag:pagtag pageVo="${pageVO}" url="S.go" /></td>
                </tr>
             </table></td>
           </tr>
         </table></td>
 ...
 <tr>
         <td align="left" valign="middle"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-hover">
	                    ...
	                    <c:forEach var="zftd" items="${pageVO.pageData}">
                            <tr >
                             ...
                             <td align="center" valign="middle">${zftd.k01}</td>
                              ...
                              <td align="center" valign="middle"> <a href="/WMKLH1/${zftd.puk}/R.go">${zftd.f04}</a></td>
                               ...
                               <c:choose>
							  <c:when test="${zftd.ddd=='0'}">
							    <td align="center" valign="middle">正常</td>
							  </c:when>
							   <c:when test="${zftd.ddd=='1'}">
							     <td align="center" valign="middle">异常</td>
							  </c:when>
                            ...
                            <td align="center" valign="middle"><a href="${zftd.puk}/W.go">审核未通过</a></td>
          
                            <td align="center" valign="middle"><a href="${zftd.puk}/G.go">审核通过</a></td>
