...
<html lang="en">
  ...
  <base href="<%=basePath%>">    
   ...
   <!-- Bootstrap -->
	...
	function cx(){
		document.form1.action="/WMJG01/F.go";
		form1.submit();
	}
	</script>
  </head>
	...
	<tr style="border-bottom:1px solid #DBDBDB; border-left:1px solid #DBDBDB; border-right:1px solid #DBDBDB;">
		<td>
			...
			<table align="center" width="100%" style="margin:0; padding:0;" border="0">
				...
				<tr height="40">
					<td width="20%" align="right">授权联系人</td>
					<td width="5"></td>
					<td>
					<input type="text" class="form-control input-sm" id="f07" name="f07" value="" style="width: 200px;"/>
					</td>
					<td width="5">&nbsp;</td>
					<td></td>
				</tr>
				<tr height="40">
					<td width="20%" align="right">分站管理员</td>
					<td width="5"></td>
					<td>
					<input type="text" class="form-control input-sm" id="k03" name="k03" value="" style="width: 200px;"/>
					</td>
					<td width="5">&nbsp;</td>
					<td></td>
				</tr>
...
<!-- 					<td width="5"></td> -->
<!-- 					<td> -->
<!-- 					<select id="f01" name="f01" style="width: 200px;"> -->
<!-- 	        			<option></option> -->
<!-- 	        			<c:forEach var="item" items="${listCpkh}"> -->
