...
@Named
/** 供应商添加厂商信息*/
public class MGYS2_GYSTJCSXXDBO extends MyDataBaseObjectSupport
{
    /** 
     * 供应商ID
     */
     ...
     * 获取（备用字段）
     *
     * @return F36_BYZD （备用字段）
     */
    public String getF36_byzd() {
        return this.f36_byzd;
    }
     ...
     * @param F36_BYZD （备用字段）
     */
    public void setF36_byzd(String F36_BYZD) {
        this.f36_byzd = F36_BYZD;
    }
