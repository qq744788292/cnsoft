...
@Named
/** 医院添加商品信息*/
public class MYY2_YYTJSPXXDBO extends MyDataBaseObjectSupport
{
    /** 
     * 医院ID
     */
    private String p11_yyid = "";
     ...
     * 获取医院ID
     *
     * @return P11_YYID 医院ID
     */
    public String getP11_yyid() {
        return this.p11_yyid;
    }
     ...
     * @param P11_YYID 医院ID
     */
    public void setP11_yyid(String P11_YYID) {
        this.p11_yyid = P11_YYID;
    }
