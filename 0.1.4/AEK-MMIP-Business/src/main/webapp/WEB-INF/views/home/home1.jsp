...
<div class="contnet" id="yui-contentBox">
	<div class="boxContentRight rFloat">
		<script src="/resources/js/usinfo1.js?t=<%=DateHelper.currentTime1()%>"></script>
		<div class="mTop10 boxContent">
			<div class="boxInfoTitle">证件提醒</div>
			<div class="boxInfoContent">
				<div class="certCountNum">
					<span>已过期证件：<a href="javascript:post('/3220020?index=0');"><em>${ZJTJY1.fb2}</em></a></span>
					<span>即将过期证件：<a href="javascript:post('/3220020?index=1')"><em>${ZJTJY1.fb1}</em></a></span>
				</div>
			</div>
		</div>
		<div class="mTop10 boxContent">
			<div class="boxInfoTitle">订购提醒</div>
			<div class="boxInfoContent">
				<div class="orderCountNum">
					等待配送：<span>采购订单 <em>6666</em></span> <span>寄销订单 <em>0</em></span><br />
				...
				<div class="tagBox">
					<div class="tagNav tagnSelect">
						<div class="indexFormSearch">
							<form id="cert-form" name="cert-form" action="/3111000" method="POST">
					...
					<div class="tagNav">
						<div class="indexFormSearch">
							<form id="supplier-form" name="supplier-form" action="/31022001" method="POST">
								<input type="text" name="f01_qyqc" id="f01_qyqc" class="text textTips {text:'请输入医院名称'}" />
		...
		<div class="mTop10 boxContent">
			...
			<div class="boxInfoContent">
				<dl class="orderTotal">
					...
					<dt>我的医院：<strong>${WDKHZSZ2.fb1}</strong></dt>
					<dd><div id="container2" style="width:400px; height:200px"></div></dd>
					<dt>我的采购单：<strong>234</strong></dt>
					<dd>
