						...
						<div class="tagNav">
							<form id="hform1" name="hform1" onsubmit="return saveInfo();">
								...
								<ul class="ulFrm">
									...
									<li><span class="label labelW100 labelRight"><em class="red">*</em>&nbsp;&nbsp;法人代表：</span> <input type="text" vd-key="nonempty"
										data-error="请输入法人代表！" id="f06_frxm" name="f06_frxm"
										value="${company.f06_frxm }" size="40" maxlength="20"
										class="text" /></li>
									<li><span class="label labelW100 labelRight"><em class="red">*</em>&nbsp;&nbsp;注册地址：</span>
										<div
										...
										class="text" /></li>
									<li><span class="label labelW100 labelRight"><em class="red">*</em>&nbsp;&nbsp;固定电话：</span>
										<input vd-key="tel" type="text" name="f16_lxdh" id="f16_lxdh" value="${company.f16_lxdh }" size="40" maxlength="20" class="text" />
									</li>
									<li><span class="label labelW100 labelRight" style="vertical-align:top;">经营范围：</span> 
										<textarea class="textarea" name="bbb" cols="80" rows="7">${company.bbb }</textarea>
										<div style="margin:10px 0 0 105px;"><a href="javascript:showLayer('/3101100', 800, true);">维护经营范围</a></div>
									</li>
									<li class="p105">
										<div class="errorMsg" id="yui-error-msg" style="width: 315px;"></div>
									</li>
									<li class="p105"><input type="submit" id="submit" name="submit" value="保存" class="btn" /></li>
								</ul>
							</form>
						</div>
					</c:if>
