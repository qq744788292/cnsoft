...
function(a) {
    ...
    a.fn.jCarouselLite = function(b) {
        ...
        this.each(function() {
            function c(a) {
                return n || (clearTimeout(A), z = a, b.beforeStart && b.beforeStart.call(this, i()), b.circular ? j(a) : k(a), m({
                    start: function() {
                        ...
                        b.afterEnd && b.afterEnd.call(this, i()),
                        b.auto && h(),
                        n = !1
                    }
                }), b.circular || l()),
            ...
            function f() {
                t = b.vertical ? s.outerHeight(!0) : s.outerWidth(!0),
                u = t * y,
                v = t * w,
                s.css({
                    width: s.width(),
            ...
            function l() {
                ...
                a(z - b.scroll < 0 && b.btnPrev || z + b.scroll > y - w && b.btnNext || []).addClass("disabled")
            }
            function m(c) {
                n = !0,
                q.animate("left" == o ? {
