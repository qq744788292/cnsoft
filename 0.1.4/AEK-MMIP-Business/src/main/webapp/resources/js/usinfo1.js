var uhtml = "<div class=\"boxContent\">\n\
	...
	<ul class=\"userRemind clearfix2\">\n\
		...
		<li><a href=\"javascript:void(0);\" onclick=\"post('/3140205?index=1');\" class=\"btn\">业务员管理</a></li>\n\
		<li class=\"noMar\"><a href=\"javascript:showLayer('/31022002', 500, true);\" class=\"btn\">添加医院</a></li>\n\
	</ul>\n\
	<div class=\"gray\" style=\"text-align:right;\" id=\"yui-u-date\"></div>\n\
</div>";
