...
$(function(){
	resetText();
	$(".text").input();
	new inputTips("#eb1","/2001030/12",2,"#k01_ssqyid",330);
})
				...
				<div class="tabs-mod tabs-max-2 w710 m0a">
					<div class="tabs-hd">
						<ul>
							...
							<li><a href="/3001000">供应商注册<div class="arrow"></div></a></li>
						</ul>
					</div>
					<div class="tabs-bd">
						<ul>
							<li>
								<form id="reg-form" action="/3001001" method="post">
									<div class="form-item">
										<div class="form-item-left"><em>*</em>医院名称：</div>
										<div class="form-item-right">
											<input name="eb1" id="eb1" class="text {text:'请输入医院名称'}" type="text" arrow="true" size="60" />
										</div>
									</div>
									<div class="form-item">
									...
									<input type="hidden" name="f02_yhlb" id="f02_yhlb" value="2"/>
