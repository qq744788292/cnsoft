	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12" style="margin-top:20px;"> 
				<!-- 筛选 -->
				<form class="form-inline form-search" role="form" action="/391030001" method="post">
				...
				<div class="tools-group">
					<a href="javascript:post('/391030002')" class="btn btn-primary">新增医院</a>
				</div>
				<!-- 表格 -->
						...
						<tbody id="tableList">
							<c:forEach items="${page.pageListData }" var="item" varStatus="status">
								<tr>
									...
									<td>${item.f16_lxdh }</td>
									<td>
										<a href="javascript:;" onclick="post('/391030002?puk=${item.puk}')" type="button" class="btn btn-primary btn-xs">编辑</a>
										<a href="javascript:post('/391030004?puk=${item.puk}');" onclick="return confirm('你确定要删除吗?');" type="button" class="btn btn-primary btn-xs">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
