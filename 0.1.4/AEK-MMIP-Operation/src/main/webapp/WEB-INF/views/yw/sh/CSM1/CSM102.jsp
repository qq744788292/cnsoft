...
<div class="container-fluid">
		<div class="panel panel-default mt20">
			...
			<div class="panel-heading tc">
				<a type="button" class="btn btn-default fl-l btn-xs" href="javascript:;" onclick="post('/392020001')">
			...
			<div class="panel-body">
				<form class="form-horizontal form-edit form-read submit-form" role="form" action="/392020003" method="post" id="myform">
...
<!-- 					<div class="form-group">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label label-title">医院等级：</label>
						<label class="col-sm-4 control-label label-content">${oldobj.f36_yydj }</label>
						<label class="col-sm-4 control-label label-content">${newobj.f36_yydj }</label>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label label-title">医生数目：</label>
						<label class="col-sm-4 control-label label-content">${oldobj.f37_yssm }</label>
						<label class="col-sm-4 control-label label-content">${newobj.f37_yssm }</label>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label label-title">床位数目：</label>
						<label class="col-sm-4 control-label label-content">${oldobj.f38_cwsm }</label>
						<label class="col-sm-4 control-label label-content">${newobj.f38_cwsm }</label>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label label-title">科室数目：</label>
						<label class="col-sm-4 control-label label-content">${oldobj.f39_kssm }</label>
						<label class="col-sm-4 control-label label-content">${newobj.f39_kssm }</label>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label label-title">职工人数：</label>
						<label class="col-sm-4 control-label label-content">${oldobj.f40_zgrs }</label>
						<label class="col-sm-4 control-label label-content">${newobj.f40_zgrs }</label>
					</div>																				
