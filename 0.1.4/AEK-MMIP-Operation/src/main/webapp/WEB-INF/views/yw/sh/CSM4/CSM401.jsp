	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12" style="margin-top:20px;"> 
				<!-- 筛选 -->
				<form class="form-inline form-search" role="form" action="/39205001" method="post">
						...
						<tbody id="tableList">
							...
							<tr>
								...
								<td>
								    <c:choose>
											<c:when test="${item.n03_shzt=='2' }">
												<a href="javascript:;" onclick="post('/39205002?puk=${item.puk}')" type="button" class="btn btn-primary btn-xs">比较</a>
											</c:when>
											<c:otherwise>
