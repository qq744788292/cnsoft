...
var OpenWindow = function(title/*标题*/,content/*显示内容*/,style/*窗口样式*/,fun/*窗口关闭回调函数*/,flag){
	...
	this.init = function(){	//初始化窗口
            ...
            var style = $(".owBj").length > 0 ? "none" : "block",
                html = "<div class=\"owBj\" style=\"display:" + style + ";width:" + this.width + "px;height:" + this.height + "px; top:0; left:0;\"></div><div class=\"owBox\" id=\""+ this.name +"\" style=\"display:none;\"><div class=\"owTitle\""+(title == "notitle"?'style=\"display:none;\"':'')+"><span class=\"owtName\">"+ this.title +"</span><a href=\"#\" class=\"owClose\"></a></div><div class=\"owContent\">" + this.content + "</div></div>",
