...
$(function(){
	$("#errorMsg").errMsg('${page_message}', -1);
});
</c:if>
		...
		<div class="login pos-absolute">
			<div class="pos-relative">
				...
				<div class="mTop18">
					...
					<a href="javascript:changCode(this.src);" title="看不清，点击换一张？"><img src="/00003031/92/35?t=<%=DateHelper.currentTime1()%>" id="vcode" style="height:40px; width:96px; vertical-align:middle;" /></a>
				</div>
