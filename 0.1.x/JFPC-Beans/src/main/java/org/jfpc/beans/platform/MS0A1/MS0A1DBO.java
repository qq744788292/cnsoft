package org.jfpc.beans.platform.MS0A1;
...
@Named
/** 系统菜单定义*/
public class MS0A1DBO extends MyDataBaseObjectSupport
{
    /** 
     * 显示父菜单ID
     */
