package org.jfpc.framework.mq.service;

import org.jfpc.constants.ISMQConstants;
import org.jfpc.framework.mq.bean.MQConfigBean;
...
public class MyMQSendServer implements ISMQConstants {
	...
	public boolean send(String message) {
		...
		template.setRoutingKey(target.getQueueName() + DOT + NAME_BAR);
