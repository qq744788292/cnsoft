...
//@ControllerAdvice
public class ModelAttributeHandle implements ISFrameworkConstants, ISModelConstants {
...
//				// 从缓存里面获得
//				token = (String) super.getSessionAttribute(CONSTANT_USER_TOKEN);
//				if (EmptyHelper.isEmpty(token)) {
//					check = false;
//				}
//			}
//		}
//		// 获得 用户资料
//		LoginerBean loginer=null;
//		if(check){
//			if (logger.isDebugEnabled())
//				logger.error("Token///////////////>>>>>>=====" + token);
//			loginer = super.getLoginerBean();
//			if(EmptyHelper.isEmpty(loginer.getUserName())){
//				//打印日志
//				// 判断TOKEN有效性
//				loginer = new LoginerBean();
//				loginer.setToken(token);
//				//loginService.doCheckToken(loginer);
//				if(EmptyHelper.isEmpty(loginer.getUserName())){
//					check = false;
//				}else{
//					super.setLoginerBean(loginer);
//				}
//			}
//			
//		}
...
//		if(check){
//			if (logger.isDebugEnabled())
//				logger.error("CONSTANT_LOGINER///////CONSTANT_LOGINER///>>>>>>=====" + loginer);
//			check = loadUserInfo(request, response, session);//加载用户信息
//		}
//		
//		if(check==false){
//			// 初始化失败
