...
public class CloundApiConfig  implements IHDPConstants, ISFrameworkConstants {
	 ...
	 * 匿名业务
	 */
	Map<String, String> anonymousConfig = new HashMap<String, String>();
	
	public Map<String, String> getAnonymousConfig() {
		return anonymousConfig;
	}

	public void setAnonymousConfig(Map<String, String> anonymousConfig) {
	 ...
	 * 日常监听业务
	 */
	Map<String, String> monitorConfig = new HashMap<String, String>();
