 ...
 */
@Service("PatientRefundBusinessImpl")
public class PatientRefundBusinessImpl extends AHospitalProcessService {
	private static final Logger logger = LoggerFactory.getLogger(PatientRefundBusinessImpl.class);
	public PatientRefundBusinessImpl() {
