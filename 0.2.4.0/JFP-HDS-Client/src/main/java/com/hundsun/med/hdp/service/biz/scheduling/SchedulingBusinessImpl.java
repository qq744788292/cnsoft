package com.hundsun.med.hdp.service.biz.scheduling;
 ...
 * @see <SchedulingSendService>
 */
@Service("SchedulingBusinessImpl")
public class SchedulingBusinessImpl extends AHospitalProcessService {

	public SchedulingBusinessImpl() {
		setBizName(ACCESSS_SchedulingBusiness);
	}
	...
	public boolean doProcess() throws Exception {
		// 服务获取
		AHospitalDataSyncService service = BeanFactoryHelper.getBean(SERVICE_TSCHEDULE);
		// 运行接收
		if (service != null)
