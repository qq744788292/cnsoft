...
import org.isotope.jfp.framework.token.TokenBusinessSupport;
 ...
 *
 */
public class MyTokenCommonSupport implements ISFrameworkConstants {
	...
	public boolean checkSecurityCode(HttpServletRequest request, HttpServletResponse response, boolean autodelete) {
		...
		return checkSecurityCode(token, curCode, false);
	}
