 ...
 */
public abstract class AMessageChannelServiceThreadSupport extends CommonChannelConfig implements Runnable, ISFrameworkConstants, ISReceive, ISInit, ISCheck, ISProcess, ISFinished {
	/**
	 * 等待时间（毫秒）
	 */
