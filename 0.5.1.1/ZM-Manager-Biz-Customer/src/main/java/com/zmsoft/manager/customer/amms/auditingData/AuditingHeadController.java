...
@Controller
public class AuditingHeadController extends MyControllerSupport implements IFrameworkConstants{
     ...
     * @author 王杰
     */
    @RequestMapping(value = "/20101110",method = RequestMethod.POST)
    public ModelAndView doSelectPage20101110(U101010UserInfoDBO u101010UserDBO, PageModel<U101010UserInfoDBO> pageModel, RESTResultBean<String> message){
        ModelAndView modelAndView=getModelAndView("/customer/auditingData/auditingHead-list");
        ...
        U101010UserInfoService_.doSelectPageByHead(pageModel);
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/20101130",method = RequestMethod.POST)
    public RESTResultBean doUpdate20101130(U101010UserInfoDBO u101010UserInfoDBO,RESTResultBean<String> message){
     ...
     * @author 王杰
     */
    @RequestMapping(value = "/20101131",method = RequestMethod.POST)
    public ModelAndView see20101131(U101010UserInfoDBO u101010UserInfoDBO){
        ModelAndView modelAndView=getModelAndView("/customer/auditingData/auditingHead-see");
