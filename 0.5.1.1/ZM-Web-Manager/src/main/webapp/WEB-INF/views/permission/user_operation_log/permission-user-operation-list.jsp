...
<table style="border-collapse:separate; border-spacing:0px 20px;">
    <form method="post" action="/90801010?token=${token}" id="searchForm">
    ...
    <input type="hidden" name="pageLimit" id="pageLimit" value="10">
        <tr class="trparam" >
            <td>
                <table>
                    <tr>
                         <td class="tdparam">用户姓名:</td>
                        <td style="width: 150px">
                            <input type="text"  class="form-control" name="userName" placeholder="请输入帐号" value="${searchCondition.userName}">
                        </td>
                        <td class="tdparam">用户帐号:</td>
                        <td style="width: 150px">
                            <input type="text"  class="form-control" name="userAccount" placeholder="请输入帐号" value="${searchCondition.userPhone}">
                        </td>
                        <td class="tdbtn">
    ...
    <tr style="margin-top:50px;" >
        <td>
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                <c:forEach var="item" items="${model.pageListData}">
                    <tr>
                        <td>${item.userName}</td>
    ...
    <%--分页信息--%>
    <tr>
        <td><p:page page="${model}" url="90801010" /></td>
    </tr>
</table>
