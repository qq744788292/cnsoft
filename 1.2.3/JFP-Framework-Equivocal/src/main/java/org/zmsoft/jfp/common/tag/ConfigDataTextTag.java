...
import org.zmsoft.jfp.framework.cache.ISSystemDataCache;
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (TAG_PARAMETER.equals(tableName)) {
				ISSystemDataCache<SystemParameterDBO> SystemParameterService_ = BeanFactoryHelper.getBean("SystemParameterService");
				...
				ISSystemDataCache<SystemClassifyDBO> SystemClassifyService_ = BeanFactoryHelper.getBean("SystemClassifyCacheService");
				...
				ISSystemDataCache<SystemConfigDBO> SystemConfigCacheService_ = BeanFactoryHelper.getBean("SystemConfigCacheService");
