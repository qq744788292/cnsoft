...
public class SystemCacheManagerService extends MyWorkSupport implements ISProcess, Runnable {
	...
	List<ASystemDataCacheSupport<T>> serviceList;

	public void setServiceList(List<ASystemDataCacheSupport<T>> serviceList) {
	...
	public void run() {
		...
		for (ASystemDataCacheSupport<T> item : serviceList){
			logger.debug("=====>>>>>"+item);
