...
@CrossOrigin
@RestController
@RequestMapping(value = "/doc/1.0/base/s902010role", method = { RequestMethod.GET})
public class S902010RoleApiDoc extends MyApiDocSupport { 
    ...
    public JSONObject loadApiDocValue() throws Exception {
        ...
        //输出基本信息
        all.put("name", "系统角色定义表");
        all.put("baseurl", "/api/1.0/base/s902010role");
        //输出API列表
        {
