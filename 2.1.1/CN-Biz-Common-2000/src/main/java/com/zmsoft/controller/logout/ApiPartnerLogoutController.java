...
@CrossOrigin
@RestController
@RequestMapping(value = "/app/1.0/partner/home", method = { RequestMethod.POST })
public class ApiPartnerLogoutController extends MyTokenCommonSupport implements ICacheConstants {
