...
public interface IFrameworkConstants {
	 ...
	 * 系统拦截错误页面
	 */
	public final static String SYSTEM_ROOT = "/error";
	/**
	 * 系统接口拦截错误页面
	 */
	 ...
	 * 手机验证码redis前缀
	 */
	public String  PHONE_SECURITY_CODE = "PHONENUM:SecurityCode";
	/**
	 * 管理员权限缓存
	 */
	public static final String MANAGER_ROLE_KEY = "CACHE:MANAGER:ROLE:";
