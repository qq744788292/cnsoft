 ...
 */
public class WxJsapiTicketSupport extends MyBusinessLogicSupport {
	...
	*/
	...
	/**
	  * 获得数据签名
	  * @param [request, jsapi_ticket, url]
	  * @return JSONObject
	  * @throws Exception
	  * @author Zmsoft
	  * @version 0.1.0 2018/4/2
	  * @since 0.1.0 2018/4/2
	*/
	public  JSONObject sign(HttpServletRequest request, String jsapi_ticket, String url) {
