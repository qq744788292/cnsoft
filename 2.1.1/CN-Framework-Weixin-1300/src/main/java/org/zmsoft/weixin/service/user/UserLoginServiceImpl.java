package org.zmsoft.weixin.service.user;
...
public class UserLoginServiceImpl extends MyTokenCommonSupport implements ISUserLoginSupport<UserBean>, ICacheConstants {
	 ...
	 * 账号密码登录
	 */
	public RESTResultBean<UserBean> doDefaultLogin(HttpServletRequest request, LoginerBean loginer) throws Exception {
	 ...
	 * 自动登录
	 */
	public RESTResultBean<UserBean> doAutoLogin(HttpServletRequest request, String token, String unionId) throws Exception {
	 ...
	 * 微信登录
	 */
	public RESTResultBean<UserBean> doWeixinLogin(HttpServletRequest request, WxUserBean wxUserBean) throws Exception {
		// 根据OpenID查找用户
