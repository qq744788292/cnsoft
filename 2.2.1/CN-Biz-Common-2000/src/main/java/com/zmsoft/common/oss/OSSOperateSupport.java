...
public class OSSOperateSupport implements IFrameworkConstants {
	...
	//                                    http://jsjp.oss-cn-hongkong.aliyuncs.com/20190518/2a718323328a4982afaed850ee08277b.png
	private static String publicServer = "http://jsjp.oss-cn-hongkong.aliyuncs.com/";//外网访问地址
	private static String uploadServer = "http://oss-cn-hongkong-internal.aliyuncs.com";//上传地址
	private static String accessKeyId = "LTAIC0trUz88aO6J";
	private static String accessKeySecret = "DvlVLf4CeI98rdLUngaK7m1tupfAI5";
	private static String bucketName = "jsjp";
	...
	public String putObject(byte[] file, String docname, boolean path) throws Throwable {
		OSSClient ossClient = new OSSClient(uploadServer, accessKeyId, accessKeySecret);
		try {
...
//			System.out.println(url);
	...
	public void removeObject(String key) throws IOException {
		...
		OSSClient client = new OSSClient(uploadServer, accessKeyId, accessKeySecret);
