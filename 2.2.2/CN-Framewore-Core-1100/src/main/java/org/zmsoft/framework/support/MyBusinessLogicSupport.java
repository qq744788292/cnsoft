 ...
 * @param <E>
 */
public class MyBusinessLogicSupport extends MyTokenCommonSupport implements ILoginer {

	protected RESTResultBean<T> result;
	 ...
	 * @return
	 */
	public RESTResultBean<T> getResult() {
		return result;
	}
