...
import org.zmsoft.framework.config.ISProcess;
import org.zmsoft.framework.config.ISTask;
 ...
 */
public abstract class AJobSupport extends MyFrameWorkSupport implements IJobConstants, ISProcess, ISTask {
