...
import org.zmsoft.persistent.common.SystemClassify.SystemClassifyDao;
...
public class SystemClassifyCacheService extends ASystemDataCacheSupport<SystemClassifyDBO> {
	 ...
	 * @return
	 */
	public List<SystemClassifyDBO> loadClassifys(String hdp, boolean load) {
	...
	public List<SystemClassifyDBO> getDatasFromDB(int pageCurrent, SystemClassifyDBO param) {
		SystemClassifyDao service = MyBeanFactoryHelper.getBean(SystemClassifyDao.class.getSimpleName());
