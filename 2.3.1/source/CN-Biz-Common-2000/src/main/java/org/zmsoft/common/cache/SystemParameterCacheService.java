...
import org.zmsoft.persistent.common.SystemParameter.SystemParameterDao;
...
public class SystemParameterCacheService extends ASystemDataCacheSupport<SystemParameterDBO> {
	 ...
	 * @return
	 */
	public List<SystemParameterDBO> loadParameters(String type) {
	 ...
	 * @return
	 */
	public SystemParameterDBO loadParameter(String type, String key) {
		SystemParameterDBO param = new SystemParameterDBO();
		param.setType(type);
		param.setKey(key);
	...
	public List<SystemParameterDBO> getDatasFromDB(int pageCurrent, SystemParameterDBO param) {
		SystemParameterDao service = MyBeanFactoryHelper.getBean(SystemParameterDao.class.getSimpleName());
