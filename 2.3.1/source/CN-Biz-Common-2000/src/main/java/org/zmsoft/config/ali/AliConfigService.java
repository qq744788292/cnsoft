 ...
 * 阿里支付配置
 */
@Service("AliConfigService")
// @Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class AliConfigService extends AConfigSupport implements ISConfig {

	private final static String TYPE = "ali.config";
