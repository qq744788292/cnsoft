 ...
 * @since 2.0.0 2018/10/10 {@link https://help.aliyun.com/document_detail/32008.html?spm=a2c4g.11186623.2.6.3c6f5d26i2YeBE}
 */
@Service("MyFileOperatorSupport")
public class MyFileOperatorSupport implements ICFrameworkConstants {
	...
	public OSSClient getOssClient() {
		return new OSSClient(configOSS.getUploadServer(), configOSS.getAccessKeyId(), configOSS.getAccessKeySecret());
	}
	...
	public static void main(String[] args) throws Exception, Throwable {
		MyFileOperatorSupport a = new MyFileOperatorSupport();
