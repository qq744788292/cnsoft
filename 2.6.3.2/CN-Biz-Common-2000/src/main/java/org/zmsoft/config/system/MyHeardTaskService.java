...
import org.zmsoft.common.service.MyMQOperatorSupport;
...
public class MyHeardTaskService extends AJobTaskSupport implements ICCacheConstants {
	...
	public boolean doProcess() throws Exception {
		...
		myMQOperatorSupport.set(CACHE_KEY_SERVER + name, data.toString());
		myMQOperatorSupport.set(CACHE_KEY_SERVER + data.getHost(), data.toString());

		return true;
	}

	@Resource
	MyMQOperatorSupport myMQOperatorSupport;
