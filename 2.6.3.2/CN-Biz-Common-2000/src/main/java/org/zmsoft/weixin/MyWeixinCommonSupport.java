...
import org.zmsoft.config.wx.WxShareConfigService;
...
public class MyWeixinCommonSupport extends MyTokenCommonSupport implements ICBussinessConstants, ICWeixinConstants {
	...
	//微信配置
	private WxShareConfigService wxShareConfigService;
	public WxShareConfigService getWxShareConfigService() {
		if (EmptyHelper.isEmpty(wxShareConfigService))
			wxShareConfigService = MyBeanFactoryHelper.getBean(WxShareConfigService.class);
		return wxShareConfigService;
	}
