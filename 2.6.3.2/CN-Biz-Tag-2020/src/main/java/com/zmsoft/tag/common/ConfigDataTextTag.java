	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (TAG_PARAMETER.equals(tableName)) {
				ASystemDataCacheSupport<SystemParameterDBO> _SystemParameterService_ = MyBeanFactoryHelper.getBean(SystemParameterCacheService.class);
				...
				ASystemDataCacheSupport<SystemClassifyDBO> _SystemClassifyService_ = MyBeanFactoryHelper.getBean(SystemClassifyCacheService.class);
				...
				ASystemDataCacheSupport<SystemConfigDBO> _SystemConfigCacheService_ = MyBeanFactoryHelper.getBean(SystemConfigCacheService.class);
