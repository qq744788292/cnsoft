 ...
 */
public class SHA1SecurityHelper implements ICFrameworkConstants {
	public static String SHA1(Map<String, String> maps) throws Exception {
		// 获取信息摘要 - 参数字典排序后字符串
	...
	public static String SHA1(String decrypt) throws Exception {
		try {
			...
			digest.update(decrypt.getBytes(SYSTEM_CHARSET));
			// 获取字节数组
