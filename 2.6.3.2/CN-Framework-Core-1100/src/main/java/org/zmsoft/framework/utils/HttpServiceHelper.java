 ...
 */
public class HttpServiceHelper implements ICFrameworkConstants {
	 ...
	 * @throws Exception
	 */
	protected static CloseableHttpClient getCloseableHttpClient(String serviceURL, HttpHost httpProxy) throws Exception {
		// 创建HttpClientBuilder
	...
	public static String doHttpPOST(String serviceURL, JSONObject json) throws Exception {
		return doHttpPOST(null, serviceURL, json.toString(), false);
	}
	...
	public static String doHttpPOST(CloseableHttpClient httpclient, String serviceURL, String data, boolean josn) throws Exception {
		logger.debug("=====>>>>>接口请求<<<<<=====" + serviceURL);
		if (httpclient == null)
		...
		try {
			...
			if (josn == true) {
	            ...
	            s.setContentEncoding(SYSTEM_CHARSET);
	...
	public static String doHttpPOST(String serviceURL, Map<String, String> param, Map<String, String> headers) throws Exception {
		return doHttpPOST(serviceURL, param, headers, null);
	}

	public static String doHttpPOST(String serviceURL, Map<String, String> param, Map<String, String> headers, Map<String, String> cookies) throws Exception {
		logger.debug("=====>>>>>接口请求<<<<<=====" + serviceURL);
		CloseableHttpClient httpclient = getCloseableHttpClient(serviceURL);
