...
public class PageCheckCodeImageController extends MyContentTypeSupport {
	...
	public void doCommonCodeDefault(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception {
		// int width = 65;// 设置图片的宽度
		// int height = 22;// 设置图片的高度
		doCommonCode(65, 22, request, response, session);
	}
	...
	public void doCommonCode(@PathVariable int width, @PathVariable int height, 
			HttpServletRequest request, HttpServletResponse response, HttpSession session) throws Exception {
		doCommonCodeCustom(width, height, EMPTY, EMPTY, request, response, session);
	}
	...
	public void doCommonCodeCustom(@PathVariable int width, @PathVariable int height, 
