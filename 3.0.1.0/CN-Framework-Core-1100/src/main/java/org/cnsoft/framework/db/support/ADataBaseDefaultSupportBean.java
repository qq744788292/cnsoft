...
import org.cnsoft.framework.db.MyManagerNameTransHelper;
 ...
 */
public abstract class ADataBaseDefaultSupportBean extends MyDataBaseObjectBean implements ICDBConstants, ISLoginer {

	/**
	 * 名称转换器
	 */
	public final static String convertServiceName = "mySystemNameTransSupport";
	 ...
	 */
	public void prepareUpdator(int flag, boolean lock) {
		if (flag == 0) {
			return;
		}
		...
		if (lock && EmptyHelper.isEmpty(getUpdateTime())) {
			setUpdateTime(t);// 设置乐观锁-更新时间
		}
