...
import org.cnsoft.framework.job.bean.ScheduleJobBean;
import org.cnsoft.framework.job.impl.QuartzDisallowJobImpl;
import org.cnsoft.framework.job.impl.QuartzJobImpl;
 ...
 */
@Component("MyQuartzTaskManagement")
public class MyQuartzTaskManagement implements ICFrameworkConstants {

	protected Logger logger = LoggerFactory.getLogger(this.getClass());
	
	public final static String Quartz_Management_Name ="MyQuartzManagementService";
	...
	public void stopJob(ScheduleJobBean scheduleJobBean) throws SchedulerException {
		...
		logger.debug("=====>>>>>=====>>>>>监控任务准备关闭=====>>>>>=====>>>>>" + scheduleJobBean.getJobId() + "." + scheduleJobBean.getJobName());
			schedulerFactory = MyBeanFactoryHelper.getBean("schedulerFactoryBean");
		// 移除原有任务
