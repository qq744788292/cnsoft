...
public class TokenBusinessHelper implements ICFrameworkConstants {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(getUnionToken("987321", "1256", "abcdefghi", "gov"));
	...
	public static String getUnionToken(String... data) throws Exception {
		return MD5SecurityHelper.encrypt(getBizTokenData(data));
	}

	/**
	 * 交叉混淆，可以正序或者倒序，可以奇数和偶数
	 * 
	 * @param data token 算法数据
	 * @return tonkenString
	 * @throws Exception
	 */
