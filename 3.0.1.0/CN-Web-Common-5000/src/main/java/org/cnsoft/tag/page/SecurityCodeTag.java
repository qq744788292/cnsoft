	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			if (EmptyHelper.isNotEmpty(token)) {
				...
				sb.append("<td><input type=\"text\" class=\"form-control\" name=\"" + name + "\" " + id
						+ "placeholder=\"安全码\" /></td>");
				sb.append("<td width=\"" + size + "%\" >&nbsp;</td>");
				sb.append("<td><img src=\"/99993030?token=" + token
						+ "\" width=\"65\" height=\"22\" onclick=\"this.src='/99993030?token=" + token
						+ "&d='+Math.random();\"/></td>");
				sb.append("</tr>");
				sb.append("</table>");
