...
import org.zmsoft.jfp.framework.elk.ELKLogSendConnection;
import org.zmsoft.jfp.framework.job.bean.JobLogBean;
...
import org.zmsoft.jfp.framework.utils.JSONHelper;
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			if ("1000".equals(scheduleJobBean.getJobType())) {
				// 变量初始化
				Class<?> clazz = BeanFactoryHelper.getBean(scheduleJobBean.getSpringBeanId());
